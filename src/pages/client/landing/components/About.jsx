...
import profileScreen from "../../../../assets/profile-preview.png";
...
const InteractiveIcon = ({
  ...
  return (
    <span
      ...
      className="p-0.5 bg-gradient-to-tr from-neutral-700 via-neutral-900 to-neutral-700 rounded-full shadow-lg hover:bg-gradient-to-tr hover:from-[var(--color-primary-hover-dark)] hover:via-[var(--color-primary-hover)] hover:to-[var(--color-primary-hover-dark)] cursor-pointer transition-all duration-300"
    >
      <div
        className="p-3 sm:p-4 bg-black rounded-full transition-all duration-300"
        style={{
          background:
        ...
        <div className="text-start flex-1 flex flex-col justify-center px-2">
          ...
          <div className="min-h-[40px] sm:min-h-[50px] flex items-center justify-center">
            {hoveredIcon ? (
              ...
              <p className="text-gray-300 text-xs sm:text-sm leading-relaxed animate-bounce">
                <Mouse />
              </p>
            )}
          </div>
